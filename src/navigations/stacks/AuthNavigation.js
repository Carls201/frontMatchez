...
import { AuthStartScreen, LoginScreen, RegistroScreen } from "../../screens/Auth";
...
export function AuthNavigation() {
    return (
        <Stack.Navigator screenOptions={{
            ...
            <Stack.Screen name={screens.auth.registroScreen} component={RegistroScreen} options={{title:"Registrarse"}}/>
        </Stack.Navigator>
    )
}